...
class ActivityForm(forms.ModelForm):
    ...
    description = forms.Field(widget=Textarea(attrs={'class': "form-control form-block"}))
    initial_rotation = forms.IntegerField(widget=NumberInput(attrs={'class': "form-control form-block"}))
